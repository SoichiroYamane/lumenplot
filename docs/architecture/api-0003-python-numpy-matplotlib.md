...
- Status: **Accepted staged Phase-3A contract — Phase-3A2 helper/package/builder same-wheel evidence is recorded (CI-local manifest; GIL CPython 3.11–3.14); Phase-3B public Matplotlib contract accepted as API 0005/ADR 0015 with implementation and public-backend evidence pending**
- Date: 2026-08-21
