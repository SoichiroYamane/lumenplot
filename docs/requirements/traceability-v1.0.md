...
| `LP-SEC` | unsafe boundary, runtime shader policy, input validation, provenance, SBOM, fonts, and public docs | PR #118 adds bounded line-only runtime-negative-guard and artifact-verification evidence for `LP-SEC-003`/`005`; broader runtime/provenance/SBOM/font/docs evidence remains pending. |
