...
| `LP-FUNC-033` | `MUST` | `AT-FUNC-BAR` | Implemented (bounded Phase-3B local contract evidence: PR #69 + PR #89 eligibility + PR #102 fixtures + PR #107 convergence; bar eligibility with §5.4 Agg-oracle parity fixtures in `test_phase3b_bar.py` plus `TestCommittedBarFixture`, `TestBarNativeAggParity` in `test_agg_oracle_bar.py`; release claim stays open) |
