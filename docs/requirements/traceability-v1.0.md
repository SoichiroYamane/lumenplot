...
| `LP-FUNC-032` | `MUST` | `AT-FUNC-FILL` | Not implemented — gate condition fixed: Agg parity fixtures per the §5.4 quality oracle (traceability registry Target cell) |
| `LP-FUNC-033` | `MUST` | `AT-FUNC-BAR` | Not implemented — gate condition fixed: Agg parity fixtures per the §5.4 quality oracle (traceability registry Target cell) |
| `LP-FUNC-034` | `MUST` | `AT-FUNC-DRAWSTYLE` | Not implemented — gate condition fixed: Agg parity fixtures per the §5.4 quality oracle (traceability registry Target cell) |
