...
| `LP-QUAL-012` | `MUST` | `AT-SEC-SHADER` | Implemented (bounded M3 Phase-B local contract evidence: PR #118; declared line class validated at build time and before GPU use, passing in the CI Rust gate; additional classes and GPU execution remain open) |
