...
| [0013](0013-hidden-facade-private-python-line-png.md) | Accepted staged contract — Phase-3A implementation and evidence pending; Phase-3B public Matplotlib contract accepted in ADR 0015/API 0005 with evidence pending | Hidden facade and private Python line/PNG helper | Phase-3A owned Rust seam, NumPy/GIL boundary, and helper-only package gate |
...
| [API 0003](../architecture/api-0003-python-numpy-matplotlib.md) | Accepted staged Phase-3A contract — helper evidence pending; Phase-3B public contract accepted in ADR 0015/API 0005 with evidence pending | O-02P/O-09/O-10 Python, NumPy, and Matplotlib bridge |
