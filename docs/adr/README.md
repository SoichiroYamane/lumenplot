...
| [0014](0014-phase3a2-pinned-manylinux-wheel-evidence.md) | Accepted contract — helper/package/builder same-wheel evidence recorded (CI-local manifest; GIL CPython 3.11–3.14); Phase-3B public-backend evidence remains pending | Phase-3A2 pinned manylinux private-helper wheel and same-wheel evidence | Python package/build boundary without Phase-3B/public adapter claims |
...
| [API 0003](../architecture/api-0003-python-numpy-matplotlib.md) | Accepted staged Phase-3A contract — helper/package/builder same-wheel evidence recorded (CI-local manifest; GIL CPython 3.11–3.14); Phase-3B public-backend evidence remains pending | O-02P/O-09/O-10 Python, NumPy, and Matplotlib bridge |
