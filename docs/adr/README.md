...
| [0017](0017-metal-native-adoption-decision-record.md) | Proposal — O-16 gate disposition draft for the architecture-authority; No-Go verdict recorded, nothing authorized | Metal native adoption decision record (O-16 gate disposition) | First executed O-08 bundle evaluated against the native adoption gate; native cell honestly environment required |
| [0018](0018-user-facing-png-output-description.md) | Accepted — documentation only; no code change | User-facing PNG-output description | README accuracy for shipped phases and the PNG stream description; encoder stays pinned by ADR 0012 |
