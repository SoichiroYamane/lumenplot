...
| [0016](0016-metal-prototype-lane-quarantine-crate.md) | Accepted contract — quarantine crate and activation-gated static allowance recorded; prototype implementation pending | Metal prototype lane quarantine crate | Post-v1 exploration lane: `lumenplot-render-metal` stub crate, macOS-target-gated pinned objc2 edges, fail-closed static allowance |
