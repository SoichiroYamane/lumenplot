...
| [0016](0016-v1-3d-envelope-and-agg-parity.md) | Accepted product envelope — implementation decisions and evidence pending | v1 3D envelope and Agg-parity acceptance | Promotes `LP-FUNC-025` to a Phase 3 v1 MUST; fixes artifacts-included mplot3d parity and records O-19–O-22 stop conditions |
